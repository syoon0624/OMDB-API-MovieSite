...
export default (values) => {
  if (values.toggle) {
    ...
    values.type = document.querySelector(
      'header > div > form > ul > div > #type > .type'
    ).value;
    values.pageCount =
      parseInt(
        document.querySelector(
          'header > div > form > ul > div > #length > .length'
        ).value
      ) / 10;
  } else {
    values.input = document.querySelector(
      '.search-container > form > input'
    ).value;
    values.years = document.querySelector(
      '.search-container > form > ul > div > li > .year_input'
    ).value;
    values.type = document.querySelector(
      '.search-container > form > ul > div > #type > .type'
    ).value;
    values.pageCount =
      parseInt(
        document.querySelector(
          '.search-container > form > ul > div > #length > .length'
        ).value
      ) / 10;
